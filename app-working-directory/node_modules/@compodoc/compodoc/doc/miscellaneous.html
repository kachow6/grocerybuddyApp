        ...
        <div class="xs-menu menu" id="mobile-menu">
            ...
            <nav>
                ...
                <ul class="list">
                    ...
                    <li class="title">
                        <a href="./">@compodoc/compodoc documentation</a>
                    </li>
                    ...
                    <li class="chapter">
                        <a data-type="chapter-link" href="./miscellaneous.html"  class="active" ><span class="fa fa-cubes"></span>Miscellaneous</a>
                    </li>
...
<ol class="breadcrumb">
  <li>Miscellaneous</li>
    ...
    <h2 id="inputs"><b>Variables</b></h2>
        <h4><code>test/src/sample-files/deep.module.ts</code></h4>
        <section>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <code>StoreModule:     <code>any</code>
        </bcode>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="table table-sm table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <code>RouterModule:     <code>any</code>
        </bcode>
                            </td>
                        </tr>
                    </tbody>
